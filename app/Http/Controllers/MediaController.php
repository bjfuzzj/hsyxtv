 ...
 * @LastEditTime: 2021-10-08 15:14:24
...
class MediaController extends Controller
{
    ...
    public function getWatchList(Request $request)
    {
        ...
        $sql = "select b.d_id,a.srcid,b.name,b.id_code,b.url_1,b.poster_vertical,b.type from watchlist a  inner join media b on a.srcid=b.id_code and a.userid = '".$userId."' and a.isdel=0";
        $medias = DB::select($sql);
